...
//
$dbusername="SBFspotUser";
$dbpassword="SBFspotPassword";
$dbname="SBFspot";
// Create, Check connection
$conn = new mysqli($dbserver, $dbusername, $dbpassword, $dbname);
if ($conn->connect_error) { die("Connection failed: " . $conn->connect_error); }
...
$curldate = date('Ymd', $p1timestampunix);	$curltime = date('H:i', $p1timestampunix);
$curlapi = "X-Pvoutput-Apikey: ".$pvoapi;	$curlsid = "X-Pvoutput-SystemId: ".$pvosid;
